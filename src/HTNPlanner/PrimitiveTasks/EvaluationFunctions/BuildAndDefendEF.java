...
public class BuildAndDefendEF extends EvaluationFunction {
	...
	public BuildAndDefendEF() 
	{
		...
		{
			if (Generator.FUNCTION_CLASS_TO_TRAIN.equals(BuildAndDefendEF.class)) 
			{
			...
			{
				if (Generator.CURRENT_INDIVIDUALS[1] != null) 
				{
					RESOURCE = Generator.CURRENT_INDIVIDUALS[1].genes[0].weightValue;
					RESOURCE_COLLECTION = Generator.CURRENT_INDIVIDUALS[1].genes[1].weightValue;

					W_BASE[0] = Generator.CURRENT_INDIVIDUALS[1].genes[2].weightValue;
					W_BASE[1] = -Generator.CURRENT_INDIVIDUALS[1].genes[3].weightValue;
					W_BARRACKS[0] = Generator.CURRENT_INDIVIDUALS[1].genes[4].weightValue;
					W_BARRACKS[1] = -Generator.CURRENT_INDIVIDUALS[1].genes[5].weightValue;
					W_WORKER[0] = Generator.CURRENT_INDIVIDUALS[1].genes[6].weightValue;
					W_WORKER[1] = -Generator.CURRENT_INDIVIDUALS[1].genes[7].weightValue;
					W_LIGHT[0] = Generator.CURRENT_INDIVIDUALS[1].genes[8].weightValue;
					W_LIGHT[1] = -Generator.CURRENT_INDIVIDUALS[1].genes[9].weightValue;
					W_RANGE[0] = Generator.CURRENT_INDIVIDUALS[1].genes[10].weightValue;
					W_RANGE[1] = -Generator.CURRENT_INDIVIDUALS[1].genes[11].weightValue;
					W_HEAVY[0] = Generator.CURRENT_INDIVIDUALS[1].genes[12].weightValue;
					W_HEAVY[1] = -Generator.CURRENT_INDIVIDUALS[1].genes[13].weightValue;

					W_DIST = Generator.CURRENT_INDIVIDUALS[1].genes[14].weightValue;
					return;
				}
			}
		}
		...
		if (!Helper.TRAINING_MODE_ON && Helper.USE_WEIGHTS_FROM_ARCHIVE) 
		{
			...
			if (TournamentFromArchive.CURRENT_INDIVIDUALS[1] != null) 
			{
				RESOURCE = TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[0].weightValue;
				RESOURCE_COLLECTION = TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[1].weightValue;

				W_BASE[0] = TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[2].weightValue;
				W_BASE[1] = -TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[3].weightValue;
				W_BARRACKS[0] = TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[4].weightValue;
				W_BARRACKS[1] = -TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[5].weightValue;
				W_WORKER[0] = TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[6].weightValue;
				W_WORKER[1] = -TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[7].weightValue;
				W_LIGHT[0] = TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[8].weightValue;
				W_LIGHT[1] = -TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[9].weightValue;
				W_RANGE[0] = TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[10].weightValue;
				W_RANGE[1] = -TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[11].weightValue;
				W_HEAVY[0] = TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[12].weightValue;
				W_HEAVY[1] = -TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[13].weightValue;

				W_DIST = TournamentFromArchive.CURRENT_INDIVIDUALS[1].genes[14].weightValue;
				return;
			}
